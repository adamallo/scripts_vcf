...
dothething ()
{
    ...
    then
        ...
        java -Xms512m -Xmx6G -jar $GATKJAR -T UnifiedGenotyper -R $HUMAN_GENOME -I $bam1 -o "$name_out.vcf" --intervals ${name_vcf2}_covB.bed --output_mode EMIT_ALL_SITES -glm BOTH -dcov 10000 > "$name_out.log" 2>&1
